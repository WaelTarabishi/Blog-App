...
const Home = () => {
    ...
    return (
        <div>
            <div className="flex flex-col gap-6 lg:p-24 p-10 max-w-6xl  ">
                ...
                <Link to='/search' className="text-xs  w-24 sm:text-sm text-teal-500 font-semibold hover:underline">view all posts</Link>
            </div>
            ...
            <div className="w-full  flex flex-col  py-7 justify-center items-center  ">
                ...
                {posts.length == 0 && isLoading && (
                    <div className="flex flex-row flex-wrap justify-center">
                        {[...Array(3)].map((_, index) => (
                            <div key={index} role="status" className="w-full border border-teal-500 h-[400px] rounded-lg sm:w-[430px] p-2 mt-20 mr-4">
